...
{
  return CALL_BASECRYPTLIB (X509.Services.X509GetExtendedBasicConstraints, X509GetExtendedBasicConstraints, (Cert, CertSize, BasicConstraints, BasicConstraintsSize), FALSE);
}
