...
1. -DOPENSSL_NO_AUTOALGINIT can be added for PEI and SMM.  
2. -DOPENSSL_NO_AUTOALGINIT cannot be added for DXE, because it will cause TLS/HTTPS boot fail.  
3. Add -DOPENSSL_NO_AUTOALGINIT will disable OpenSsl from adding all digests and ciphers at initialization time.  
