...
//  UINT64                         ActiveEncMask;
      ...
      if (PageDirectory2MEntry->Bits.MustBe1) {
        ...
        if (!(PhysicalAddress & (BIT21-1)) && Length >= BIT21) {
          ...
          Split2MPageTo4K (
            ...
            PageDirectory2MEntry->Uint64 & AddressEncMask,
            0,
            0
            );
          continue;
  ...
  //
  if (IsWpEnabled) {
    AddressEncMask  = GetMemEncryptionAddressMask() & PAGING_1G_ADDRESS_MASK_64;
    EnablePageTableProtection (&mPageTablePool, (UINTN)PageMapLevel4Entry, TRUE, AddressEncMask);
  }
